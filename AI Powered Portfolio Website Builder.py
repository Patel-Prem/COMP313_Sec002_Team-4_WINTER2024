...
def generate_all_portfolios(resume_text):
    # Set up OpenAI
    os.environ["OPEN_API_KEY"] = "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"
    llm = OpenAI(openai_api_key="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", temperature=0.5, max_tokens=2400)
    portfolio_paths = []
    for i in range(1, 9):
